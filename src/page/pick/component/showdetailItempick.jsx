...
import { getOrderlineByOrderNumber } from '../servicepick-all';
import PopupImage from './popupImage';



const ShowdetailItempick = ({ dataList, OrderNumber }) => {
    ...
    return (
        <div>
            <div><Button onClick={() => ShowImage(true)}>View <MdOutlineRateReview /> </Button></div>
                                    ...
                                    <div style={{ width: 350, height: 230, marginRight: 20 }}>
                                        <div style={{ width: 300, height: 200, backgroundColor: '#D0D1D1', borderRadius: 10, padding: 5 }}>
                                            {imageItem.ImageBox == "" ? <div>
                                                ...
                                                <center>
                                                    {/* <img src={imageItem.ImageBox} alt="Anti-spam" style={{ width: 210, height: 190 }} /> */}
                                    ...
                                    <Card style={{ width: '50%' }}>
                                        ...
                                        <Card.Body>
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    {item.scandate != null ? <label style={{ fontSize: 13 }}>วันที่สแกน : {Moment(item.scandate).format('DD/MM/YYYY')}</label> : ""}
                                                </div>
                                            </div>
                                        </Card.Body>
                                    </Card>
...
export default ShowdetailItempick